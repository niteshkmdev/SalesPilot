...
interface FormSearchToggleProps {
  initialQuery?: string;
}

function FormSearchToggleInner({ initialQuery = "" }: FormSearchToggleProps) {
...
export function FormSearchToggle(props: FormSearchToggleProps) {
  return (
    <Suspense
      fallback={
        <Button
