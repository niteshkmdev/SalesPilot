...
interface LeadSearchToggleProps {
  initialQuery?: string;
}

function LeadSearchToggleInner({ initialQuery = "" }: LeadSearchToggleProps) {
...
export function LeadSearchToggle(props: LeadSearchToggleProps) {
  return (
    <Suspense
      fallback={
        <Button
