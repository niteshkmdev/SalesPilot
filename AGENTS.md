...
| 07 | Dashboard v1 | `[x]` | Yes | Live role-scoped metrics/pipeline/assigned/activity/notifications; week/month/year/custom ranges; shared shadcn Calendar picker also on Leads filters. |
